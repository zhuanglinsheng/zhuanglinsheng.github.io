...
[There are some simple missing logics: Since $y'+\epsilon B_\mathcal{Y} \subset cl(P)$, then $\forall y\in y'+\epsilon/2 \cdot B_\mathcal{Y}$ should also lie in $\text{int}(cl(P))$. Thus, if we can show $y'\in P$ then we actually have showed that $y\in P$. ]
