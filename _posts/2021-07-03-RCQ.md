...
The condition that $h$ is onto is equivalent to that $0 \in \text{int}(h'(\bar{x})\mathcal{X}) = \text{int}(\text{range}(h'(\bar{x})))$. By Proposition 2 of [Perturbation of Correspondence](h{{ site.url }}/2021/03/31/Correspondence.html) we have $x\in \text{null}(h'(\bar{x}))$,
...
By Proposition 2 of [Perturbation of Correspondence](h{{ site.url }}/2021/03/31/Correspondence.html), for any $(x,t)\in\mathcal{M}^{-1}(0)$ we have
...
Finally, by the Proposition 5 of [Perturbation of Correspondence](h{{ site.url }}/2021/03/31/Correspondence.html) we know $\Psi_G(x) \equiv G(x) - \mathcal{K}$ is metric regular at the point $(\bar{x},0)$ at the rate $1/(\gamma-\kappa)$.
